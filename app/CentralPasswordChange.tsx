...
const s:Record<string,CSSProperties>={
 launch:{width:"100%",minHeight:40,border:"1px solid #cbd5e1",borderRadius:12,background:"#fff",color:"#17345f",padding:"9px 12px",fontWeight:800,boxShadow:"0 3px 10px rgba(15,23,42,.06)",cursor:"pointer",display:"flex",gap:7,alignItems:"center",justifyContent:"center",fontSize:12},
