...
function DetayModal({kayit,kapat,duzenle,yazdir,onceki,sonraki}:{kayit:TrafoKaydi;kapat:()=>void;duzenle:(k:TrafoKaydi)=>void;yazdir:(k:TrafoKaydi)=>void;onceki?:()=>void;sonraki?:()=>void}){
